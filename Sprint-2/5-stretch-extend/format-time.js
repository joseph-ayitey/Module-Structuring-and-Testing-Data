...
const currentOutput7 = formatAs12HourClock("13:15");      
const targetOutput7 = "1:15 pm";
console.assert(
  currentOutput7 === targetOutput7,
  `current output: ${currentOutput7}, target output: ${targetOutput7}`
);

const currentOutput8 = formatAs12HourClock("10:05");
const targetOutput8 = "10:05 am";
console.assert(
  currentOutput8 === targetOutput8,
  `current output: ${currentOutput8}, target output: ${targetOutput8}`
);

const currentOutput9 = formatAs12HourClock("21:50");              
const targetOutput9 = "9:50 pm";
console.assert(
  currentOutput9 === targetOutput9,
  `current output: ${currentOutput9}, target output: ${targetOutput9}`
);

const currentOutput10 = formatAs12HourClock("14:00");           
const targetOutput10 = "2:00 pm";
console.assert(
