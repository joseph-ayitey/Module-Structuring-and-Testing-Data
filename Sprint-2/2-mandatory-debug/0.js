...
console.log(`The result of multiplying 10 and 32 is ${multiply(10, 32)}`);  // Now output: "The result of multiplying 10 and 32 is 320"
// The function now returns the product, which is then correctly displayed in the console log
